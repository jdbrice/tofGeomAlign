...
void qaMaker( const Char_t * geomTag = "detp geometry y2014a", const Char_t *fileList = "only1.lis",
				const Char_t *nTupleName = "output.ntuple.root", string alignFile = "db/geometry.txt" )
{
	...
	vpdCalib->setCalibFilePvpd("/star/institutions/rice/jdb/run14/auau15/finalTofCalibration/tofGeomAlign/ntupler/db/vpd_4DB.dat");
	...
	btofCalib->setCalibFileTot(   "/star/institutions/rice/jdb/run14/auau15/finalTofCalibration/tofGeomAlign/ntupler/db/tot_4DB.dat");
	btofCalib->setCalibFileZhit(  "/star/institutions/rice/jdb/run14/auau15/finalTofCalibration/tofGeomAlign/ntupler/db/z_4DB.dat");
	btofCalib->setCalibFileT0(    "pass1_t0_4DB.dat");



	StBTofQAMaker *qaMaker = new StBTofQAMaker(muDstMaker, nTupleName);
